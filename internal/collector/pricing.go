...
// EffectivePricing returns the pricing table for cfg: preset rates plus any user overrides.
...
// CacheWritePerMillion and CacheReadPerMillion default to standard ratios
// (1.25× and 0.10× input) when zero.
...
// directTable contains Anthropic direct API rates in USD per 1 million tokens.
...
//
// Cache rates use the model's explicit CacheWritePerMillion/CacheReadPerMillion
// when set. When zero, standard ratios apply: cache reads at 10% of input,
